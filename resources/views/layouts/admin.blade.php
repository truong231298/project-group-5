                    ...
                    <div class="center">
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    <form action="{{route('logout')}}" id="logout-form" method="POST"> {{--logout method--}}
                                        @csrf
                                    <a href="{{route('logout')}}" class="" onclick="event.preventDefault();document.getElementById('logout-form').submit();"></form>
                                        <div class="icon"><i class="icon-settings"></i></div>
                ...
                <div class="section-content-right">
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">Group 5</span>
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2025 Group 5</div>
                        </div>
                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (index, item) {
                                var link = "{{ route('admin.product.edit', ['id' => 'product_id']) }}".replace('product_id', item.id);
